...
const getRectStartX = (phasePage: number[]): number =>
    phasePage?.length > 0
        ? GANTT_START_X + MONTH_WIDTH * (phasePage[0] - 1)
        : 0;
const getMilestoneX = (phasePage: number[]): number =>
    phasePage?.length > 0
        ? MILESTONE_START_X +
          MONTH_WIDTH *
              ((phasePage[0] === 0 ? GANTT_PAGE_WIDTH : phasePage[0]) - 1)
        : -1;
...
@Component({
    selector: 'lib-export-temporal',
    templateUrl: 'export-temporal.component.html'
})
export class GanttTemporalExportComponent implements AfterViewInit {
    ...
    private getPageValues = (key: string) =>
        this.pageMap?.has(key) ? this.pageMap?.get(key) : [];

    private isActive = (key: string) =>
        this.pageMap.has(key) ? !!this.pageMap.get(key)[2] : false;
    ...
    getComunicazioneElencoPermessiPage = (): number[] =>
        this.getPageValues('CEP');
    ...
    getStartProcurementMateriali = (): number =>
        getRectStartX(this.getProcurementMaterialiPage());
    getWidthProcurementMateriali = (): number =>
        getRectWidth(this.getProcurementMaterialiPage());

    getStartProcurementLavori = (): number =>
        getRectStartX(this.getProcurementLavoriPage());
    getWidthProcurementLavori = (): number =>
        getRectWidth(this.getProcurementLavoriPage());

    getStartCostruzione = (): number =>
        getRectStartX(this.getCostruzionePage());
    ...
    getIngegneriaDuration = (): string =>
        getPaddedString(
            this.isActive('ING') ? this.durationMap?.get('ING')?.duration : 0
        );
    getPermessiDuration = (): string =>
        getPaddedString(
            this.isActive('PS') ? this.durationMap?.get('PS')?.duration : 0
        );
    getProcurementMaterialiDuration = (): string =>
        getPaddedString(
            this.isActive('MAT') ? this.durationMap?.get('MAT')?.duration : 0
        );
    getProcurementLavoriDuration = (): string =>
        getPaddedString(
            this.isActive('PL') ? this.durationMap?.get('PL')?.duration : 0
        );
    getCostruzioneDuration = (): string =>
        getPaddedString(
            this.isActive('COS') ? this.durationMap?.get('COS')?.duration : 0
        );
    getRipristiniDuration = (): string =>
        getPaddedString(
            this.isActive('RP') ? this.durationMap?.get('RP')?.duration : 0
        );

    getStyleIngegneria = (): string =>
        `fill:${
            this.isActive('ING') ? '#9acd00ff' : '#cccccc90'
        };fill-opacity:1;stroke:none;stroke-width:0.176389;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:1`;
    getStylePermessi = (): string =>
        `fill:${
            this.isActive('PS') ? '#9acd00ff' : '#cccccc90'
        };fill-opacity:1;stroke:none;stroke-width:0.176389;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:1`;
    getStyleProcurementMateriali = (): string =>
        `fill:${
            this.isActive('MAT') ? '#9acd00ff' : '#cccccc90'
        };fill-opacity:1;stroke:none;stroke-width:0.176389;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:1`;
    getStyleProcurementLavori = (): string =>
        `fill:${
            this.isActive('PL') ? '#9acd00ff' : '#cccccc90'
        };fill-opacity:1;stroke:none;stroke-width:0.176389;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:1`;
    getStyleCostruzione = (): string =>
        `fill:${
            this.isActive('COS') ? '#9acd00ff' : '#cccccc90'
        };fill-opacity:1;stroke:none;stroke-width:0.176389;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:1`;
    getStyleRipristini = (): string =>
        `fill:${
            this.isActive('RP') ? '#9acd00ff' : '#cccccc90'
        };fill-opacity:1;stroke:none;stroke-width:0.176389;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:1`;

    getStyleComunicazioneElencoPermessi = (): string =>
        `fill:${
            this.isActive('CEP') ? '#9acd00ff' : '#cccccc90'
        };fill-opacity:1;stroke:none;stroke-width:0.176389;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:1`;
    getStyleMessaInEsercizio = (): string =>
        `fill:${
            this.isActive('EE') ? '#9acd00ff' : '#cccccc90'
        };fill-opacity:1;stroke:none;stroke-width:0.176389;stroke-miterlimit:4;stroke-dasharray:none;stroke-opacity:1`;

    hasComunicazioneElencoPermessi = (): boolean =>
        this.getComunicazioneElencoPermessiPage()[0] >= 0;
    ...
    getStartComunicazioneElencoPermessi = (): string =>
        `m ${getMilestoneX(
            this.getComunicazioneElencoPermessiPage()
        )},83 2.5,2.5 -2.5,2.5 -2.5,-2.5 z`;
    getStartMessaInEsercizio = (): string =>
        `m ${getMilestoneX(
            this.getMessaInEsercizioPage()
        )},158 2.5,2.5 -2.5,2.5 -2.5,-2.5 z`;
